...
class AuditoriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create auditorium" do
    assert_difference('Auditorium.count') do
      post auditoria_url, params: { auditorium: { name: @auditorium.name, seat_rows: @auditorium.seat_rows, seats_per_row: @auditorium.seats_per_row } }
    end
  ...
  test "should update auditorium" do
    patch auditorium_url(@auditorium), params: { auditorium: { name: @auditorium.name, seat_rows: @auditorium.seat_rows, seats_per_row: @auditorium.seats_per_row } }
